...
async function getClient() {
  ...
  // Temporary debug — remove after resolving secret mismatch
  console.log('[entra] clientId:', clientId);
  console.log('[entra] secret length:', clientSecret.length, '| first 4:', clientSecret.slice(0, 4), '| last 4:', clientSecret.slice(-4));
